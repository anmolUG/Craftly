...
class FileContent(BaseModel):
    """Structured output for the coder agent — the full content of a single file."""
    filepath: str = Field(description="The relative file path, e.g. 'index.html' or 'src/app.js'")
    content: str = Field(description="The complete file content as a plain string. Write the actual code, not a description.")